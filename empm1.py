...
12개월(1년) Momentum 관찰 / 4주(1달) Holding 

월별 리밸런싱은 은 각 월의 가장 빠른 영업일날(ex. 2016-05-01) 진행
해당월(ex. 2016-5)의 직전 월(ex. 2015-05-08~2016-4-30)까지의 데이터로 
산정한 weight 결과에 따라 리밸런싱 하는 것으로 가정
수익률은 각 월의 마지막 날(ex. 2016-05-30) 계산(관찰) 
